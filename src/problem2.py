...
def problem2a_testing():
    ...
    # Test 3
    expected =3
    actual = sum_of_digits_of_sum_of_factors(30)
    print('Test 3:')
    print('Expected:', expected)
    print('Actual:', actual)
    # Test 4
    expected =1
    actual = sum_of_digits_of_sum_of_factors(100)
    print('Test 4:')
    print('Expected:', expected)
    print('Actual:', actual)
...
def problem1c(m):
    ...
    Examples:
      ...
      -- problem1c(10) returns 60 because the prime numbers that are
           ...
           and 11 + 13 + 17 + 19 = 60.
     """
    return ((problem2b(m+1, m+9, 1)) - (problem2b(m+1, m+9, 3)))
